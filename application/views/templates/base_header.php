<?php 
	$last_update = $this->config->item("last_update");
	$time = (time() - $last_update)/ (60 * 24) <= 24 ? "?".time() : "";
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<script type="text/javascript" src="<?php echo base_url('bootstrap/js/ckeditor/ckeditor.js')."?".time(); ?>"></script>	
